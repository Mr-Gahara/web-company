export default function CTASection() {
  return (
    <div className="cta-sec" id="kontak">
      <div className="cta-inner">
        ...
        <p className="sdesc rv d2" style={{ margin: "0 auto 1.5rem" }}>
          Ceritakan kebutuhan Anda — kami identifikasi bersama di mana teknologi
          bisa memberi dampak terbesar.
        </p>
        <div className="cta-strip rv d3">
          <div>
            <div className="cstrip-text">Ada proyek di pikiran Anda?</div>
            <div className="cstrip-sub">
              Diskusi awal gratis, tanpa tekanan, tanpa agenda tersembunyi.
            </div>
          </div>
          <a
            href="https://wa.me/62895383394352"
            className="bp"
        ...
        <div className="ctacs rv d4">
          <a href="https://wa.me/62895383394352" className="ctac">
            <div className="cico">
              <svg
                width="13"
                height="13"
          ...
          <a
            href="https://www.instagram.com/tachyontechlabs/"
            target="_blank"
